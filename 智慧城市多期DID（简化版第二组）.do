...
*tab treat year
*outreg2 treat year using result2.doc, replace cross  title(Decriptive statistics)
//导出对照组与处置组样本数量表格result2.doc
...
hist pc_tp
winsor2 pc_tp, cuts(1 99) replace trim
...
*outreg2 using didresult2.doc, replace tstat bdec(3) tdec(2) ctitle(lnpc_tp) addtext(city fe, yes,year fe, yes)
...
*outreg2 using didresult2.doc, append tstat bdec(3) tdec(2) ctitle(total_score) addtext(city fe, yes,year fe, yes)
//为了输出标准表格形式，所以采取普通估计+outreg2命令，再将mi estimate数值手动修改填入
...
*outreg2 using didresultcxcy2.doc, replace tstat bdec(3) tdec(2) ctitle(new_company) addtext(city fe, yes,year fe, yes)
//为了输出标准表格形式，所以采取普通估计+outreg2命令，再将mi estimate数值手动修改填入
...
*outreg2 using didresultcxcy2.doc, append tstat bdec(3) tdec(2) ctitle(foreign_investment) addtext(city fe, yes,year fe, yes)
//为了输出标准表格形式，所以采取普通估计+outreg2命令，再将mi estimate数值手动修改填入
...
*outreg2 using didresultcxcy2.doc, append tstat bdec(3) tdec(2) ctitle(vcpe_investment) addtext(city fe, yes,year fe, yes)
//为了输出标准表格形式，所以采取普通估计+outreg2命令，再将mi estimate数值手动修改填入
...
*outreg2 using didresultcxcy2.doc, append tstat bdec(3) tdec(2) ctitle(patent_given) addtext(city fe, yes,year fe, yes)
//为了输出标准表格形式，所以采取普通估计+outreg2命令，再将mi estimate数值手动修改填入
...
*outreg2 using didresultcxcy2.doc, append tstat bdec(3) tdec(2) ctitle(label_given) addtext(city fe, yes,year fe, yes)
//为了输出标准表格形式，所以采取普通估计+outreg2命令，再将mi estimate数值手动修改填入
...
*outreg2 using didresultzl2.doc, replace tstat bdec(3) tdec(2) ctitle(lnpc_desa) addtext(city fe, yes,year fe, yes)
//为了输出标准表格形式，所以采取普通估计+outreg2命令，再将mi estimate数值手动修改填入
...
*outreg2 using didresultzl2.doc, append tstat bdec(3) tdec(2) ctitle(lnpc_inva) addtext(city fe, yes,year fe, yes)
//为了输出标准表格形式，所以采取普通估计+outreg2命令，再将mi estimate数值手动修改填入
...
*outreg2 using didresultzl2.doc, append tstat bdec(3) tdec(2) ctitle(lnpc_uma) addtext(city fe, yes,year fe, yes)
//为了输出标准表格形式，所以采取普通估计+outreg2命令，再将mi estimate数值手动修改填入
